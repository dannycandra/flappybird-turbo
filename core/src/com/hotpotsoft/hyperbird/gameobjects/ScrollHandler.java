package com.hotpotsoft.hyperbird.gameobjects;
...
//    public static final int PIPE_GAP = 49;
    ...
    private com.hotpotsoft.hyperbird.gameworld.GameWorld gameWorld;

    public ScrollHandler(com.hotpotsoft.hyperbird.gameworld.GameWorld gameWorld, float yPos) {
    ...
    public boolean collides(Bird bird) {
        ...
        if (!pipe1.isScored()
            ...
            com.hotpotsoft.hyperbird.helpers.AssetLoader.coin.play();
